...
To generate a one-pager directly from the command line:

```
python -m onepager.reporting
```

To run it via Slack instead, run:

```
python -m onepager.slack
```

and hopefully see a message in terminal saying

```
⚡️ Bolt app is running!
```

Then proceed to the Slack Workspace you chose during setup and in your desired channel enter "/invite @OnePagerBot"

...
Write a dense, factual business overview of roughly 140 to 160 words that captures: what the company does, its core products or services, how it makes money (its main segments or business lines), and who its customers are. 
...
than hitting a bullet count.

Format as a plain bulleted list, one risk per bullet, no headers, no sub-bullets, no introductory or closing sentence — just the bullets.
"""
...
Format as a plain bulleted list, one takeaway per bullet, no headers, no intro or closing sentence.
"""
